...
FEATURES ?= SIZE OFFSET STATISTICS SDL NUMA VNC TTF FBDEV SIMPLE_RFB #PIXEL_COUNT BROKEN_PTHREAD

# Declare features compiled conditionally
CODE_FEATURES = STATISTICS SDL NUMA VNC TTF FBDEV SIMPLE_RFB
...
SOURCE_SIMPLE_RFB = simple_rfb.c
HEADER_SIMPLE_RFB = simple_rfb.h
